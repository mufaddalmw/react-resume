        ...
        return(
            <React.Fragment>
                ...
                <div className="grid-container">
                    ...
                    <p>{moment(this.state.rbbi.startDate).format("MMM YYYY")} - Present <small className="gray">({this.yearsMonths(this.state.rbbi.startDate, this.state.rbbi.endDate)})</small><br/>
                        Dubai, UAE</p>
                    <ul>
                    ...
                    <p>{moment(this.state.vinfotech.startDate).format("MMM YYYY")} - {moment(this.state.vinfotech.endDate).format("MMM YYYY")} <small className="gray">({this.yearsMonths(this.state.vinfotech.startDate, this.state.vinfotech.endDate)})</small> <br/>Indore, India</p>
                    ...
                    <p>{moment(this.state.kalptaru.startDate).format("MMM YYYY")} - {moment(this.state.kalptaru.endDate).format("MMM YYYY")} <small className="gray">({this.yearsMonths(this.state.kalptaru.startDate, this.state.kalptaru.endDate)})</small><br />Indore, India</p>
                    ...
                    <p>{moment(this.state.naidunia.startDate).format("MMM YYYY")} - {moment(this.state.naidunia.endDate).format("MMM YYYY")} <small className="gray">({this.yearsMonths(this.state.naidunia.startDate, this.state.naidunia.endDate)})</small><br />Indore, India</p>
